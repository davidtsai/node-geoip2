...
NodeMMDBWorker::NodeMMDBWorker(Nan::Callback *callback, NodeMMDB *mmdb, const std::string &lookupStr) : Nan::AsyncWorker(callback),
                                                                                                        mmdb(mmdb),
                                                                                                        lookupStr(lookupStr),
                                                                                                        resultList(NULL)
{
...
static void init(Local<Object> exports)
{
    ...
    /** MMDB **/
    Local<FunctionTemplate> mmdbTpl = Nan::New<FunctionTemplate>(NodeMMDB::New);
